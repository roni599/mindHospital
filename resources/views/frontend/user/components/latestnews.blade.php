                ...
                <div class="card-blog">
                    <div class="header">
                        ...
                        <a href="blog-details.html" class="post-thumb">
                            <img src="{{ 'ui/frontend' }}/assets/img/blog/blog_1.jpg" alt="">
                        </a>
                    </div>
                    <div class="body">
                        ...
                        <div class="site-info">
                            <div class="avatar mr-2">
                                <div class="avatar-img">
                                    <img src="{{ 'ui/frontend' }}/assets/img/person/person_1.jpg" alt="">
                                </div>
            ...
            <div class="col-lg-4 py-2 wow zoomIn">
                <div class="card-blog">
                    <div class="header">
                        ...
                        <a href="blog-details.html" class="post-thumb">
                            <img src="{{ 'ui/frontend' }}/assets/img/blog/blog_2.jpg" alt="">
                        </a>
                    </div>
                    <div class="body">
            ...
            <div class="col-lg-4 py-2 wow zoomIn">
                <div class="card-blog">
                    <div class="header">
                        ...
                        <a href="blog-details.html" class="post-thumb">
                            <img src="{{ 'ui/frontend' }}/assets/img/blog/blog_3.jpg" alt="">
                        </a>
                    </div>
                    <div class="body">
                        ...
                        <div class="site-info">
                            <div class="avatar mr-2">
                                <div class="avatar-img">
                                    <img src="{{ 'ui/frontend' }}/assets/img/person/person_2.jpg" alt="">
                                </div>
